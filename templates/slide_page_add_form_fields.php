<div class="form-field">
    ...
    <input type="text" name="slide_page_meta[overlay_color]" id="overlay_color" placeholder="#FF0000">
...
<div class="form-field">
    ...
    <input type="text" name="slide_page_meta[overlay_opacity]" id="overlay_opacity" placeholder="60%">
