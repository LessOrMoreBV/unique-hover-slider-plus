<tr class="form-field">
    ...
    <td>
        <input type="text" name="slide_page_meta[title_color]" id="title_color" size="40" placeholder="#F5C949" class="colorpicker" value="<?= ( $meta['title_color'] ? $meta['title_color'] : '' ) ?>">
...
<tr class="form-field">
    ...
    <td>
        <input type="text" name="slide_page_meta[subtitle_color]" id="subtitle_color" size="40" placeholder="#FFFFFF" class="colorpicker" value="<?= ( $meta['subtitle_color'] ? $meta['subtitle_color'] : '' ) ?>">
...
<tr class="form-field">
    ...
    <td>
        <input type="text" name="slide_page_meta[overlay_color]" id="overlay_color" size="40" placeholder="#334D5C" class="colorpicker" value="<?= ( $meta['overlay_color'] ? $meta['overlay_color'] : '' ) ?>">
