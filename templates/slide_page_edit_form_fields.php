<tr class="form-field">
    ...
    <td>
        <input type="text" name="slide_page_meta[overlay_color]" id="overlay_color" size="40" placeholder="#FF0000" value="<?= ( $meta['overlay_color'] ? $meta['overlay_color'] : '' ) ?>">
...
<tr class="form-field">
    ...
    <td>
        <input type="text" name="slide_page_meta[overlay_opacity]" id="overlay_opacity" size="40" placeholder="60%" value="<?= ( $meta['overlay_opacity'] ? $meta['overlay_opacity'] : '' ) ?>">
